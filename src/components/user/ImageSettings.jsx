...
import { Image as ImageIcon, Eye, CornerUpLeft, Maximize } from 'lucide-react';
    ...
    return (
        <div className="bg-gray-850 text-white p-4 space-y-4 text-sm border-l border-gray-700/50">
            ...
            <div>
                <SectionHeader
                    title="Image"
                    rightIcon={<IconButton icon={ImageIcon} size="sm" />}
                />
                ...
                <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-1">
                        {['cover', 'contain', 'fill', 'scale-down'].map(value => (
                            <button
                                key={value}
                                onClick={() => setProp(p => p.objectFit = value)}
