...
import { Video as VideoIcon, Play, Pause, Volume2, VolumeX, RotateCcw, Eye, CornerUpLeft, Maximize } from 'lucide-react';
    ...
    return (
        <div className="bg-gray-850 text-white p-4 space-y-4 text-sm border-l border-gray-700/50">
            ...
            <div>
                <SectionHeader
                    title="Video"
                    rightIcon={<IconButton icon={VideoIcon} size="sm" />}
                />
                ...
                <div className="mb-4">
                    ...
                    <input
                        type="text"
                        value={props.poster || ''}
                        onChange={e => setProp(p => (p.poster = e.target.value))}
                ...
                {/* Playback Controls */}
                <div className="mb-4">
                    <div className="text-[10px] text-gray-400 mb-3 uppercase tracking-wider font-medium">
                        Playback
                    </div>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex items-center bg-gray-700/80 rounded-md px-2 py-1.5 border border-gray-600/50">
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        setProp(p => (p.borderRadius = parseInt(e.target.value, 10) || 0))
                                    }
